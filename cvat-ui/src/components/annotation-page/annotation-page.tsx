...
import VideoReviewWorkspace from 'components/annotation-page/video-review-workspace/video-review-workspace';
    ...
    return (
        <Layout className='cvat-annotation-page'>
            ...
            <Layout.Content className='cvat-annotation-layout-content'>
                ...
                {workspace === Workspace.VIDEO_REVIEW && <VideoReviewWorkspace />}
            </Layout.Content>
